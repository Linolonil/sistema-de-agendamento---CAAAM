...
const Admin = () => {
  ...
  return (
    ...
    <div className="h-screen w-full bg-gray-800 flex justify-center items-center p-2">
      ...
      <Card className="h-[calc(100vh-2rem)] w-1/2 max-w-[20rem] mx-auto p-6 shadow-md"
        color="gray"
      >
      ...
      <List>
        <Accordion open={open === 1}>
          ...
          <AccordionBody className="py-1">
            <List className="p-0">
            <ListItem className={LIST_ITEM_STYLES} onClick={() => setActiveSection("profile")}>
            Meu Perfil
              </ListItem>
        ...
        <Accordion open={open === 2}>
          ...
          <AccordionBody className="py-1">
            <List className="p-0">
            <ListItem className={LIST_ITEM_STYLES} onClick={() => setActiveSection("create-schedule")}>
            Criar agendamento
              </ListItem>
              <ListItem className={LIST_ITEM_STYLES} onClick={() => setActiveSection("view-schedules")}>
      ...
      <hr className="my-2 border-gray-800" />
      <List>
      <ListItem className={LIST_ITEM_STYLES} onClick={handleWhatsAppRedirect}>
      <ListItemPrefix>
    ...
    <Card className="h-[calc(100vh-2rem)] w-3/4 mx-auto p-6 shadow-md" color="gray">
    ...
    {!activeSection && (
    <Typography variant="small" className="mt-5 font-medium text-gray-500 flex justify-center">
